...
export default function FormularioAutores(props:formularioActoresProps){
    return(
        <Formik
...
interface formularioActoresProps{
    modelo: autorCreacionDTO
    onSubmit(valores: autorCreacionDTO, acciones: FormikHelpers<autorCreacionDTO>): void
}